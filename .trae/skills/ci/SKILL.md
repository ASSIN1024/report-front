---
name: ci
description: "CI红了？找我们。管道消防队出动。当用户提到CI失败、构建错误、测试失败或管道问题时使用。不要用于：本地构建、标准实现工作、审查或设置。"
...
description-zh: "CI红了？找我们。管道消防队出动。当用户提到CI失败、构建错误、测试失败或管道问题时使用。不要用于：本地构建、标准实现工作、审查或设置。"
