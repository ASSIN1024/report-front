---
name: harness-plan
description: "HAR: 任务规划、Plans.md管理、进度同步。触发词：制定计划、创建计划、添加任务、更新Plans.md、标记完成、检查进度。不要用于：实现、审查、发布。"
...
description-zh: "HAR: 任务规划、Plans.md管理、进度同步。触发词：制定计划、创建计划、添加任务、更新Plans.md、标记完成、チェック進捗。不要用于：实现、审查、发布。"
