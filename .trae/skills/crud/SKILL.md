---
name: crud
description: "快速自动生成CRUD代码。样板代码留给AI处理。当用户提到CRUD、实体生成或想创建API端点时使用。不要用于：UI组件创建、表单设计、数据库schema讨论。"
...
description-zh: "快速自动生成CRUD代码。样板代码留给AI处理。当用户提到CRUD、实体生成或想创建API端点时使用。不要用于：UI组件创建、表单设计、数据库schema讨论。"
