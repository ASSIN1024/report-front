---
name: harness-sync
description: "HAR: 同步Plans.md与实现状态。漂移检测、标记更新、回顾。触发词：sync-status、我在哪里、检查进度。--snapshot 保存快照。不要用于：规划、实现、审查、发布。"
...
description-zh: "HAR: 同步Plans.md与实现状态。漂移检测、标记更新、回顾。触发词：sync-status、我在哪里、检查进度。--snapshot 保存快照。不要用于：规划、实现、审查、发布。"
