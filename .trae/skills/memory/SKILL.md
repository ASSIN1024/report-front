---
name: memory
description: "管理SSOT、记忆和跨工具记忆搜索。decisions.md和patterns.md的守护者。当用户提到memory、SSOT、decisions.md、patterns.md、合并、迁移、SSOT升级、同步记忆、保存学习内容、记忆搜索、harness-mem、过去决策或记录此时使用。不要用于：实现工作、审查、临时笔记或会话内日志。"
...
description-zh: "管理SSOT、记忆和跨工具记忆搜索。decisions.md和patterns.md的守护者。当用户提到memory、SSOT、decisions.md、patterns.md、合并、迁移、SSOT升级、同步记忆、保存学习内容、记忆搜索、harness-mem、过去决策或记录此时使用。不要用于：实现工作、审查、临时笔记或会话内日志。"
