---
name: harness-work
description: "HAR: 执行Plans.md中的任务，从单个任务到全并行团队运行。触发词：实现、执行、全部完成、breezing、团队运行、parallel。不要用于：规划、审查、发布、设置。"
...
description-zh: "HAR: 执行Plans.md中的任务，从单个任务到全并行团队运行。触发词：实现、执行、全部完成、breezing、团队运行、parallel。不要用于：规划、审查、发布、设置。"
