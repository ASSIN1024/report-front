---
name: ui
description: "生成UI组件和反馈表单。当用户提到组件、UI、hero sections、表单、反馈或联系请求时使用。不要用于：身份验证功能、后端实现、数据库操作或业务逻辑。"
...
description-zh: "生成UI组件和反馈表单。当用户提到组件、UI、hero sections、表单、反馈或联系请求时使用。不要用于：身份验证功能、后端实现、数据库操作或业务逻辑。"
