---
name: session
description: "统一会话管理窗口。处理初始化、记忆、状态一体化。仅限显式/session调用——子技能处理自动委托。当管理Claude Code会话、/session命令时使用。不要用于：应用程序用户会话、登录状态、身份验证功能。"
...
description-zh: "统一会话管理窗口。处理初始化、记忆、状态一体化。仅限显式/session调用——子技能处理自动委托。当管理Claude Code会话、/session命令时使用。不要用于：应用程序用户会话、登录状态、身份验证功能。"
