---
name: harness-review
description: "HAR: 多角度代码、计划、范围审查。安全/质量检查。触发词：review、代码审查、计划审查、范围分析。不要用于：实现、新功能、bug修复、设置、发布。"
...
description-zh: "HAR: 多角度代码、计划、范围审查。安全/质量检查。触发词：review、代码审查、计划审查、范围分析。不要用于：实现、新功能、bug修复、设置、发布。"
