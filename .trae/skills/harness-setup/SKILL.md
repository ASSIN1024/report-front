---
name: harness-setup
description: "HAR: 项目初始化、工具配置、Agent设置、记忆设置、技能同步。触发词：setup、init、新项目、CI/Codex设置、harness-mem、mirror。不要用于：实现、审查、发布、规划。"
...
description-zh: "HAR: 项目初始化、工具配置、Agent设置、记忆设置、技能同步。触发词：setup、init、新项目、CI/Codex设置、harness-mem、mirror。不要用于：实现、审查、发布、规划。"
