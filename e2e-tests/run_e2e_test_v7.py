...
class E2ETestRunner:
    ...
    def test_report_config(self):
        ...
        try:
            ...
            mapping_table.locator('input[placeholder="如: A"]').nth(0).type('A')
            mapping_table.locator('input[placeholder="如: order_id"]').nth(0).click()
            mapping_table.locator('input[placeholder="如: order_id"]').nth(0).type('col_a')
            ...
            mapping_table.locator('input[placeholder="如: A"]').nth(1).type('B')
            mapping_table.locator('input[placeholder="如: order_id"]').nth(1).click()
            mapping_table.locator('input[placeholder="如: order_id"]').nth(1).type('col_b')
            ...
            mapping_table.locator('input[placeholder="如: A"]').nth(2).type('C')
            mapping_table.locator('input[placeholder="如: order_id"]').nth(2).click()
            mapping_table.locator('input[placeholder="如: order_id"]').nth(2).type('col_c')
